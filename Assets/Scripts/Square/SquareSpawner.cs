...
{
    [SerializeField]
    private SquareController[] cubePrefabs;
    ...
    {
        var randomPrefabIndex = Random.Range(0, cubePrefabs.Length);

        var square = Instantiate(cubePrefabs[randomPrefabIndex], transform);
